const { insertProject, deleteProject, updateProject, selectProject, insertExAc, selectExAc, insertCareer, selectCareer, insertTeQu, selectTeQu, insertLaCe, selectLaCe, insertContact, selectContact, selectProjectDetail } = require("./DB")
